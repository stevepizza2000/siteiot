...
function validarLogin(emailLogin, senhaLogin, spanEmailLogin, spanSenhaLogin, modalLogin, secoesProtegidas, acoesLogado) {
    // variavel para checar se o form passa nas verificações basicas, como todos os campos estarem preenchidos
    let formularioValido = true;
...
window.onload = function () {
    ...
    enviarLogin.addEventListener("submit", function (event) {
        event.preventDefault();
        validarLogin(emailLogin, senhaLogin, spanEmailLogin, spanSenhaLogin, modalLogin, secoesProtegidas, acoesLogado);
    });
